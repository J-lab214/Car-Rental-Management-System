        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            <div class="form-group">
              ...
              <input type="text" name="fullname" class="form-control white_bg" id="fullname" required maxlength="20" pattern="[A-Za-z]+">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="contactno" class="form-control white_bg" id="phonenumber" required maxlength="10" pattern=""^[0-9]{6}|[0-9]{8}|[0-9]{10}$"">
            </div>
            <div class="form-group">
